...
output reg [FLOAT_PRECISION-1:0] fo_re, fo_im;
...
reg next_out_valid;
reg [FLOAT_PRECISION-1:0] next_fo_re, next_fo_im;
...
u_stage_8 (
    ...
    .do_re(next_fo_re), .do_im(next_fo_im)
);
...
always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
        ...
        fi_im_reg <= fi_im;
        s_re_1_reg <= s_re_1;
        s_im_1_reg <= s_im_1 ^ 64'h8000_0000_0000_0000;
        s_re_2_reg <= s_re_2;
        s_im_2_reg <= s_im_2 ^ 64'h8000_0000_0000_0000;
        s_re_3_reg <= s_re_3;
        s_im_3_reg <= s_im_3 ^ 64'h8000_0000_0000_0000;
        s_re_4_reg <= s_re_4;
        s_im_4_reg <= s_im_4 ^ 64'h8000_0000_0000_0000;
        s_re_5_reg <= s_re_5;
        s_im_5_reg <= s_im_5 ^ 64'h8000_0000_0000_0000;
        s_re_6_reg <= s_re_6;
        s_im_6_reg <= s_im_6 ^ 64'h8000_0000_0000_0000;
        s_re_7_reg <= s_re_7;
        s_im_7_reg <= s_im_7 ^ 64'h8000_0000_0000_0000;
        s_re_8_reg <= s_re_8;
        s_im_8_reg <= s_im_8 ^ 64'h8000_0000_0000_0000;
        out_valid <= next_out_valid;
        fo_re <= next_fo_re;
        fo_im <= next_fo_im;
    end
