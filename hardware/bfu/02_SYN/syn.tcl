...
set_dont_retime [get_cells {X_re_reg*}] true
set_dont_retime [get_cells {X_im_reg*}] true
set_dont_retime [get_cells {Y_re_reg*}] true
set_dont_retime [get_cells {Y_im_reg*}] true
